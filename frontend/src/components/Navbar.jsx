...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-slate-200 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-stone-400">
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user ? (
              <button className="bg-gray-700 hover:bg-gray-500 text-white text-sm py-2 px-3 rounded-md flex items-center transition duration-300 ease-in-out font-medium">
                <LogOut size={18} />
              </button>
            ) : (
              <>
